...
export const deployedProjects: ProjectShowcase[] = [
  ...
  { slug: "architask-ai", name: "ArchiTask AI", category: "Architecture générative", tagline: "Du plan 2D à une expérience 3D immersive pour concevoir, chiffrer et présenter autrement.", url: "https://archiplan.76.13.129.252.sslip.io/", preview: "/projects/architask-ai.webp", accent: "#27689D", status: "deployed", kind: "platform" },
